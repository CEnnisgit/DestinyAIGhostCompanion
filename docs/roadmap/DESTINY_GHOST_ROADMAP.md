...
### 🟢 Code-complete (live verification of OAuth/voice/equip pending real credentials)
2. [Phase 4: Infrastructure Adapters](./PHASE_4_Infrastructure/README.md)
   ...
   - 🟢 [4E: Lore RAG Slice](./PHASE_4_Infrastructure/PHASE_4E_Lore_RAG_Slice.md) — Manifest ETL + pgvector search *(pipeline complete; vector search verified live; manifest download needs real Bungie/embeddings keys)*
